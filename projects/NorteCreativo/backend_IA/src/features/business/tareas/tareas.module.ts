...
import { TAREA_REPOSITORY } from './domain/interfaces/tarea-repository.interface.js';
import { TareaRepository } from './infrastructure/repositories/tarea.repository.js';
import { TareaSeeder } from './infrastructure/seeders/tarea.seeder.js';
import { TareasController } from './presentation/controllers/tareas.controller.js';
